    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('contacts.show', $contact->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-800 text-sm font-medium rounded-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name" 
                                    ...
                                    required value="{{ old('name', $contact->name) }}" placeholder="Enter contact name">
                                @error('name')
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" id="notes" rows="4" 
                                    ...
                                    placeholder="Add any additional information about this contact">{{ old('notes', $contact->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
